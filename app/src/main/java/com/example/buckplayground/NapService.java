...
public class NapService extends IntentService {
    ...
    private static final String ACTION_FOO = "com.example.buckplayground.action.FOO";
    private static final String ACTION_BAZ = "com.example.buckplayground.action.BAZ";
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, NapService.class);
